...
- (void)viewDidLoad
{
    ...
    UIBarButtonItem *addButton = [[UIBarButtonItem alloc] initWithTitle:@"Add" style:UIBarButtonItemStylePlain target:self action:@selector(tappedAddCheatCode:)];
    self.navigationItem.leftBarButtonItems = @[self.editButtonItem, addButton];
